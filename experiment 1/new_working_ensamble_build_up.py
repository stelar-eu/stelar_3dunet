...
for test_img_number in range(255):
    ...
    ensambled_result_image_c = get_labels_in_color(ensambled_result_image)
    ensambled_ground_truth_c = get_labels_in_color(ensambled_ground_truth)
    ensambled_result_image_gen_c = get_labels_in_color(ensambled_result_image_gen)
    ...
    for i in range(64):
        ...
        plt.axis('off')
    if class_weights:
        plt.savefig('/home/luser/stelar_3d/ensamble_results/class_weight_4_models/LAI_'+str(test_img_number)+'.png', bbox_inches='tight')
    else:
        plt.savefig('/home/luser/stelar_3d/ensamble_results/no_oversampling/LAI_'+str(test_img_number)+'.png', bbox_inches='tight')
    plt.close()
    ...
    concatenated_ensambles = np.concatenate((ensambled_ground_truth, ensambled_result_image))
    ...
    if class_weights:
        plt.savefig('/home/luser/stelar_3d/ensamble_results/class_weight_4_models/ground_truth_pred'+str(test_img_number)+'.png', bbox_inches='tight')
    else:
        plt.savefig('/home/luser/stelar_3d/ensamble_results/no_oversampling/ground_truth_pred'+str(test_img_number)+'.png', bbox_inches='tight')
    plt.close()
