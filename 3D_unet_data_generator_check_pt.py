...
conda activate stcon4
cd stelar_3dunet/
python3 3D_unet_data_generator_check_pt.py --crop_1 33 --crop_2 34 --crop_3 36
...
checkpoint_path = '/mdadm0/chethan_krishnamurth/stelar_3dunet/storage/data_gen_model/checkpoints/3D_unet_res_labels_' + vista_crop_dict[chosen_crop_types_list[0]] + '_' + vista_crop_dict[chosen_crop_types_list[1]] + '_' + vista_crop_dict[chosen_crop_types_list[2]] + '_epoch_{epoch:02d}.h5'
...
model.save('/mdadm0/chethan_krishnamurth/stelar_3dunet/storage/data_gen_model/3D_unet_res_labels_'+vista_crop_dict[chosen_crop_types_list[0]]+'_'+vista_crop_dict[chosen_crop_types_list[1]]+'_'+vista_crop_dict[chosen_crop_types_list[2]]+'_num_epocs_'+str(num_epochs)+'.h5')
