...
cd stelar_3dunet/
source spt19/bin/activate
python3 3D_unet_bias_mit_1_representation_class_weights_and_RGBLAI_more_data.py --crop_1 1 --crop_2 2 --crop_3 3
python3 3D_unet_bias_mit_1_representation_class_weights_and_RGBLAI_more_data.py --crop_1 18 --crop_2 19 --crop_3 20
...
model.save('/home/luser/stelar_3dunet/storage/saved_model_rgblai/3D_unet_res_labels_'+vista_crop_dict[chosen_crop_types_list[0]]+'_'+vista_crop_dict[chosen_crop_types_list[1]]+'_'+vista_crop_dict[chosen_crop_types_list[2]]+'_num_epocs_'+str(num_epochs)+'.h5')
