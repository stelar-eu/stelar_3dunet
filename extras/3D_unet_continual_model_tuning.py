...
python3 3D_unet_continual_model_tuning.py --crop_1 37 --crop_2 40 --crop_3 41
...
cd stelar_3dunet/
source spt19/bin/activate
python3 3D_unet_continual_model_tuning.py --crop_1 4 --crop_2 5 --crop_3 7
python3 3D_unet_continual_model_tuning.py --crop_1 33 --crop_2 34 --crop_3 35
python3 3D_unet_continual_model_tuning.py --crop_1 36 --crop_2 37 --crop_3 40
python3 3D_unet_continual_model_tuning.py --crop_1 37 --crop_2 40 --crop_3 41
...
chosen_crop_types_list_1 = [cr_1, cr_2, cr_3, 4, 5, 7]
...
all_input_mask_f = []
counted = 0
for crop_no in chosen_crop_types_list_1:
    ...
    input_img_f = np.concatenate((input_img, input_img0, input_img1, input_img2, input_img3, input_img4, input_img5, input_img6), axis=0)
    input_mask_f = np.concatenate((input_mask, input_mask0, input_mask1, input_mask2, input_mask3, input_mask4, input_mask5, input_mask6), axis=0)
...
model.save('/home/luser/stelar_3dunet/storage/continual_models/3D_unet_res_labels_'+vista_crop_dict[chosen_crop_types_list[0]]+'_'+vista_crop_dict[chosen_crop_types_list[1]]+'_'+vista_crop_dict[chosen_crop_types_list[2]]+'_num_epocs_'+str(num_epochs)+'.h5')
