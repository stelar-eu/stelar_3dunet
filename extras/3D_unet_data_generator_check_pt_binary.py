...
# vscode-remote://ssh-remote%2B137.193.63.132/home/luser/stelar_3dunet/dataset/france2/lai_ras
...
cd stelar_3dunet/
python3 3D_unet_data_generator_check_pt_binary.py --crop_1 37 --crop_2 40 --crop_3 41 --binary_sel 41
...
parser.add_argument('--binary_sel', type=int, default=3, help='Select crop type')
...
checkpoint_path = './storage/data_gen_model/checkpoints/3D_unet_res_labels_' + vista_crop_dict[chosen_crop_types_list[0]] + '_' + vista_crop_dict[chosen_crop_types_list[1]] + '_' + vista_crop_dict[chosen_crop_types_list[2]]+'_binary_sel_'+vista_crop_dict[binary_sel]+'_epoch_{epoch:02d}.h5'
...
dice_loss = sm.losses.DiceLoss(class_weights=np.array([weights[0], weights[1]])) 
...
model.save('./storage/data_gen_model/3D_unet_res_labels_'+vista_crop_dict[chosen_crop_types_list[0]]+'_'+vista_crop_dict[chosen_crop_types_list[1]]+'_'+vista_crop_dict[chosen_crop_types_list[2]]+'_binary_sel_'+vista_crop_dict[binary_sel]+'_num_epocs_'+str(num_epochs)+'.h5')
