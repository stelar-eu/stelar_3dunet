...
cd stelar_3dunet/
conda activate inn
python traiing_data_per_crop.py --chosen_crop_types 33
...
for i in range(per_crop_spatio_temporal_data_size):
    ...
    tifffile.imsave('/home/luser/stelar_3dunet/storage/per_crop_data_labels/'+vista_crop_dict[chosen_crop_types]+'/train'+vista_crop_dict[chosen_crop_types]+'n5.tif', array_lai)


    array_lab = spatial_label_batches.cpu().numpy()
    tifffile.imsave('/home/luser/stelar_3dunet/storage/per_crop_data_labels/'+vista_crop_dict[chosen_crop_types]+'/lab'+vista_crop_dict[chosen_crop_types]+'n5.tif', array_lab)
