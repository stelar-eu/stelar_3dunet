...
input_mask[input_mask==9]=1
input_mask[input_mask==11]=2
input_mask[input_mask==13]=3
...
model.save('/home/luser/stelar_3d/storage/saved_model/3D_unet_res_labels_'+vista_crop_dict[0]+'_'+vista_crop_dict[9]+'_'+vista_crop_dict[11]+'_'+vista_crop_dict[13]+'_num_epocs_'+str(num_epochs)+'.h5')