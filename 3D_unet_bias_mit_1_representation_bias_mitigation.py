...
cd stelar_3dunet/
source spt19/bin/activate
python3 3D_unet_bias_mit_1_representation_bias_mitigation.py --crop_1 1 --crop_2 2 --crop_3 3
python3 3D_unet_bias_mit_1_representation_bias_mitigation.py --crop_1 18 --crop_2 19 --crop_3 20
python3 3D_unet_bias_mit_1_representation_bias_mitigation.py --crop_1 21 --crop_2 23 --crop_3 27
...
cd stelar_3dunet/
source spt19/bin/activate
python3 3D_unet_bias_mit_1_representation_bias_mitigation.py --crop_1 4 --crop_2 5 --crop_3 7
python3 3D_unet_bias_mit_1_representation_bias_mitigation.py --crop_1 33 --crop_2 34 --crop_3 35
python3 3D_unet_bias_mit_1_representation_bias_mitigation.py --crop_1 36 --crop_2 37 --crop_3 40
python3 3D_unet_bias_mit_1_representation_bias_mitigation.py --crop_1 37 --crop_2 40 --crop_3 41
...
sampling_group_fractions = [0.023, 1.0, 0.4547]
...
selected_counts_fractions = selected_counts/np.max(selected_counts)
print("selected_counts", selected_counts)
print("selected_counts_fractions", selected_counts_fractions)
...
model.save('/home/luser/stelar_3dunet/storage/saved_model_bias_miti/3D_unet_res_labels_'+vista_crop_dict[chosen_crop_types_list[0]]+'_'+vista_crop_dict[chosen_crop_types_list[1]]+'_'+vista_crop_dict[chosen_crop_types_list[2]]+'_num_epocs_'+str(num_epochs)+'.h5')
