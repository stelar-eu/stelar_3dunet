...
cd stelar_3dunet/
conda activate inn2
python traiing_data_per_crop1.py --chosen_crop_types 33


export CUDA_VISIBLE_DEVICES=0
cd stelar_3dunet/
conda activate inn2
python traiing_data_per_crop1.py --chosen_crop_types 34

export CUDA_VISIBLE_DEVICES=1
cd stelar_3dunet/
conda activate inn2
python traiing_data_per_crop1.py --chosen_crop_types 35

export CUDA_VISIBLE_DEVICES=0
cd stelar_3dunet/
conda activate inn2
python traiing_data_per_crop1.py --chosen_crop_types 36

export CUDA_VISIBLE_DEVICES=1
cd stelar_3dunet/
conda activate inn2
python traiing_data_per_crop1.py --chosen_crop_types 37

export CUDA_VISIBLE_DEVICES=0
cd stelar_3dunet/
conda activate inn2
python traiing_data_per_crop1.py --chosen_crop_types 40

export CUDA_VISIBLE_DEVICES=1
cd stelar_3dunet/
conda activate inn2
python traiing_data_per_crop1.py --chosen_crop_types 41
...
Winter crops
    ...
    time_strip_inds_winter = [60, 146, 237]
...
tifffile.imsave('./storage/per_crop_data_labels/'+vista_crop_dict[chosen_crop_types]+'/train'+vista_crop_dict[chosen_crop_types]+'n.tif', array_lai)


array_lab = all_labels.cpu().numpy()
tifffile.imsave('./storage/per_crop_data_labels/'+vista_crop_dict[chosen_crop_types]+'/lab'+vista_crop_dict[chosen_crop_types]+'n.tif', array_lab)
